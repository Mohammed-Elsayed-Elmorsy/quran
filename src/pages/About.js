                ...
                <div className='py-[30px] container mx-auto px-5 md:px-[80px] lg:px-[120px]'>
                    {state &&
                        <div className=' flex flex-col gap-5 text-[20px]'>
                            ...
                            <p data-aos={'fade-up'}>مرحبًا بكم في أكاديمية قرآن واي طريقكم الموثوق لتعلم القرآن الكريم، واللغة العربية،
                            ...
                            <p data-aos={'fade-left'}>يضم فريقنا معلمين ومعلمات مؤهلين وذوي خبرة عالية، خريجو جامعة الأزهر الشريف،
                            ...
                            <div className=' grid grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 gap-4 text-center'>
                                <img data-aos={'fade-up'} src={image} alt="" className='p-1 bg-white rounded-md  h-[200px]  xl:h-[250px] object-cover' />
                                <img data-aos={'fade-down'} src={image2} alt="" className='p-1 bg-white rounded-md  h-[200px]  xl:h-[250px] object-cover' />
                                <img data-aos={'fade-up'} src={image3} alt="" className='p-1 bg-white rounded-md  h-[200px]  xl:h-[250px] object-cover' />
                                <img data-aos={'fade-down'} src={image4} alt="" className='p-1 bg-white rounded-md  h-[200px]  xl:h-[250px] object-cover' />
                            </div>
                    ...
                    {!state && <div className=' flex flex-col gap-5 text-[20px]'>
                        ...
                        <p data-aos={'fade-up'}>Welcome to Quran Way Academy,
                        ...
                        <div className=' grid grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 gap-4 text-center'>
                            <img data-aos={'fade-up'} src={image} alt="" className='p-1 bg-white rounded-md  h-[200px]  xl:h-[250px] object-cover' />
                            <img data-aos={'fade-up'} src={image2} alt="" className='p-1 bg-white rounded-md  h-[200px]  xl:h-[250px] object-cover' />
                            <img data-aos={'fade-up'} src={image3} alt="" className='p-1 bg-white rounded-md  h-[200px]  xl:h-[250px] object-cover' />
                            <img data-aos={'fade-up'} src={image4} alt="" className='p-1 bg-white rounded-md  h-[200px]  xl:h-[250px] object-cover' />
                        </div>
                        <p data-aos={'fade-up'}>
